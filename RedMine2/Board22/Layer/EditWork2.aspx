<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditWork2.aspx.cs" Inherits="Board22.Layer.EditWork2" %>
...
<uc1:Top ID="Top" runat="server" />
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
   ...
   <script type="text/javascript" src="EditWorks2.js"></script>
        ...
        <div class="box tabular" style="margin-left:130px">
                <table>
                    ...
                    <td class="auto-style21">  <asp:Label ID="WC_Name" runat="server" Text="＊" ForeColor="#FF3300"></asp:Label> </td>
                        <td >
                      <%--     <input id="txtTitle" runat="server" type="text" class="auto-style9" />--%>
                            <asp:TextBox ID="txtTitle" runat="server" class="auto-style9" ></asp:TextBox>

                           <%-- <asp:TextBox ID="txtTitle1" runat="server" class="auto-style9"></asp:TextBox>--%>
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
     ...
     <div class="ui-dialog-titlebar ui-widget-header1 ui-corner-all ui-helper-clearfix" style="text-align:left; height:60px">새 버전&nbsp;
      ...
      <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
        ...
        <div class="btn">
            <a class="btn_big" href="javascript:EditWorks2();"><strong>편집하기</strong></a>
            <a class="btn_big" href="javascript:EditGoWorks2();"><strong>편집하고 계속하기</strong></a>
              <a href="#">미리보기</a>
        </div>
