...
namespace Board22.Layer
{
    public partial class Works : System.Web.UI.Page
    {
        ...
        {
            string returnString = "";
            returnString += "<a href='Work.aspx?sn=" + serialNo;
            returnString += "' /*class='Board'*/>" + title  + "</a>";
            return returnString;
        }
        protected string ShowWorkState(string num)
        {
            return num;
        }
        ...
        {
            //string connectionString = WebConfigurationManager.ConnectionStrings["Red"].ConnectionString;
        ...
        private void BindingList()
        {
            ...
            using (appDac = new WorkDac())
            {

                DataSet ds = null;
                ds = appDac.CreateAppBaseInfo("1",out int totalCount, _TOPSIZE, this._page, this._searchKeyword);
