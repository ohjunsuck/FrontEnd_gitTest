...
namespace GW.Approval.Web.Class
{
    public class CommonEditor
    {
        ...
        {
            GW.Approval.Web.Class.RegularText Reqular = new GW.Approval.Web.Class.RegularText(Value, GW.Approval.Web.Class.RegularType.TagExcept);
