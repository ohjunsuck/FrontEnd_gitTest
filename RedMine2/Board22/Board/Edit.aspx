<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Board22.Board.Edit" %>
...
<body>
    <form id="form1" action="Edit.aspx" method="post" >
            ...
            <table class="tbl01" cellpadding="0" cellspacing="0">
                ...
                <tr><td class="td05">· 작성자: </td>
                    <td style="height: 30px">
                       ...
                       <%-- <input type="text" name="editwriter" value= <%=writer %>>--%>
                        <%=writer %>
                    </td></tr>
...
<%--                <a href="Edit.aspx?loginid=<%=Request.QueryString["loginid"]%>&loginPassword=<%=Request.QueryString["loginPassword"] %>"   >[수정]</a>--%>
                  <input type="submit"  id="Submit1" value="수정" name="Submit1" /> 
