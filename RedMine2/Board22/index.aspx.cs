...
namespace Board22
{
    public partial class index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //m_ID = System.Web.HttpContext.Current.Request.Form["txtId"];
        ...
        //if(m_Password != tempstring)
        //{
        //    Response.Write("로그인 실패");
        //}

        ViewData = System.Web.HttpContext.Current.Request.Form["Submit1"];
            string temp = System.Web.HttpContext.Current.Request.Form["Submit2"];
            if (temp == "게시판")
                m_bHome = false;
            else m_bHome = true;
