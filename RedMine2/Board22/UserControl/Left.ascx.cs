...
namespace Board22.UserControl
{
    ...
    public partial class Left : System.Web.UI.UserControl
    {
        ...
        //    WebConfigurationManager.ConnectionStrings["Board"].ConnectionString;
        ...
        //    cmd.Connection = conn;
        //    cmd.CommandText =
        //    "SELECT * FROM ACCOUNT WHERE ID='" + m_ID + "'";
        //    conn.Open();
        ...
        //    string SearchPasswordSQL = "SELECT PASSWORD FROM ACCOUNT WHERE ID ='" + m_ID + "'";
        ...
        //    conn2.Open();
        //    string SearchadminSQL = "SELECT ADMIN FROM ACCOUNT WHERE ID ='" + m_ID + "'";
        ...
        //    if (!IsPostBack)
        //    {
        //        if (m_Password == tempstring && tempstring != "")  //여기에  session 값이 있으면 무조건 와야하는데... 
        //        {
